...
`changed something <None>`_ in that file, you
should do
::
...
.. warning::
   ...
   services <None>`_ automatically. :command:`nixos-rebuild` only runs a
...
::
    ...
    `users.users.your-user.initialHashedPassword <None>`_ = "test";
