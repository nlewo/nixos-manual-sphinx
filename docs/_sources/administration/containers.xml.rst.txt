...
:command:`nixos-container`, and declaratively, by specifying them in
your :file:`configuration.nix`. The declarative approach implies
that containers get upgraded along with your host system when you run
:command:`nixos-rebuild`, which is often not what you want. By
contrast, in the imperative approach, containers are configured and updated
independently from the host system.

.. toctree::

   imperative-containers.xml.rst

.. toctree::

   declarative-containers.xml.rst

.. toctree::

   container-networking.xml.rst
