...
``builtins.trace``
`functions <https://nixos.org/nix/manual/#ssec-builtins>`_
...
.. _sec-assertions-assertions:

Assertions
~~~~~~~~~~

This example, extracted from the
`syslogd module <https://github.com/NixOS/nixpkgs/blob/release-17.09/nixos/modules/services/logging/syslogd.nix>`_ shows how to use
