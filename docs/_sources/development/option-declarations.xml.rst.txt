...
`package attribute name <https://nixos.org/nixpkgs/manual/#sec-package-naming>`_ when referencing a Nixpkgs package. For
...
``type``
    ...
    The type of the option (see :ref:`sec-option-types`). It may
...
(:ref:`ex-option-declaration-eot-service`), and to extend
it in each backend module
(:ref:`ex-option-declaration-eot-backend-gdm`,
:ref:`ex-option-declaration-eot-backend-sddm`).
