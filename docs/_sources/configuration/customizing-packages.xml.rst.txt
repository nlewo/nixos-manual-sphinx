...
can be set in :file:`configuration.nix` as follows: :file:`
...
.. parsed-literal::
    ...
    :ref:`opt-environment.systemPackages`  = [ (pkgs.emacs.override { gtk = pkgs.gtk3; }) ];
...
them, :ref:`opt-environment.systemPackages` would be a list with
two elements.)
