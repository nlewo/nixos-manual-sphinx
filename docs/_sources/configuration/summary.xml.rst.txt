...
`Nix
manual <http://nixos.org/nix/manual/#chap-writing-nix-expressions>`_ for the rest.
...
Assertion check (evaluates to ``"yes!"``). See :ref:`sec-assertions` for using assertions in modules
